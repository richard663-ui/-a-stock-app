...
import services.train_l1_60s_model_v4r as t
...
def main() -> None:
    with tempfile.TemporaryDirectory() as td:
        ...
        try:
            ...
            assert rc == 0, f"V4R trainer rc={rc}"
            report_path = t.MODEL_DIR / "301236_SZ_training_report_latest.json"
            assert report_path.exists(), "V4R training report missing"
    ...
    print("PASS: L1 V4R synthetic DB -> rotating thinning -> asymmetric heads -> OOS report")
