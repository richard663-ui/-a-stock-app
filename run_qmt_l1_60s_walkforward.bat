...
echo V3 + iMACD + filter + meta-label + cross-rank + asymmetry
...
echo [6/8] Running V4R validation-split meta-label audit...
...
echo V4R direction is frozen; validation may keep BOTH, UP_ONLY, or DOWN_ONLY. TEST is untouched.
